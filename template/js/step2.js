...
function calServiceFees()
{
	...
	p['arrival_port']	= arrival_port;
	p['processing_time']= processing_time;
	p['private_visa']	= ($("#private_visa").is(":checked")?1:0);
	p['full_package']	= ($("#full_package").is(":checked")?1:0);
	p['fast_checkin']	= ($("#fast_checkin").is(":checked")?1:0);
	p['car_pickup']		= ($("#car_pickup").is(":checked")?1:0);
	p['car_type']		= car_type;
	p['num_seat']		= num_seat;
