...
<html lang="en" dir="ltr" class="no-js mac chrome desktop page--no-banner page--logo-main page--show page--show card-fields">
   <head>
      ...
      <meta property="og:title" content="Purchase Ziamond Ralo Stud Farrings" />
      <meta property="og:image" content="https://cdn.shopify.com/s/files/1/0526/4677/2928/products/20_6512ebbc-8084-4fea-890a-1e13b41465bd_1024x1024.jpg?v=1610772120" />
   ...
   <body>
	  ...
	  <? $i=0; 
		...
		$str .= '<tr class="product" data-product-id="6153538568384" data-variant-id="37912779030720" data-product-type="" data-customer-ready-visible>';
		$str .= '<td class="product__image">';
		$str .= '<div class="product-thumbnail ">';
		$str .= '<div class="product-thumbnail__wrapper">';
		$str .= '<img alt="Ziamond Ralo Stud Farrings" class="product-thumbnail__image" src="'.$product->thumbnail.'" />';
		$str .= '</div>';
      $sale = !empty($item['sale'])?$item['sale']:0;
		$str .= '<span class="product-thumbnail__quantity quantity-'.$i.'" cost="'.$item['price'].'" sale="'.$sale.'" aria-hidden="true">'.$item['qty'].'</span>';
		$str .= '</div>';
		$str .= '</td>';
		$str .= '<th class="product__description" scope="row">';
		$str .= '<span class="product__description__name order-summary__emphasis">'.$product->{$prop['title']}.'</span>';
		
		$typename = '';
		$typename .= $item['typename'];
		$typename .= !empty($item['subtypename'])?" - ".$item['subtypename']:"";

		$str .= '<span class="product__description__variant order-summary__small-text" style="color: #4caf50;">'.$typename.'</span>';
      if (!empty($item['sale'])) {
		   $str .= '<span class="product__description__variant order-summary__small-text">'.number_format($item['price_sale'],0,',','.').'<sup style="color:red"> -'.$item['sale'].'%</sup> <s style="color:#c1c1c1;"> '.number_format($item['price'],0,',','.').'</s></span>';
      } else {
         $str .= '<span class="product__description__variant order-summary__small-text">'.number_format($item['price_sale'],0,',','.').'</span>';
      }
      $str .= '</th>';
		$str .= '<td class="product__price">';
		$str .= '<span class="order-summary__emphasis skeleton-while-loading">'.number_format($item['qty']*$item['price_sale'],0,',','.').'</span>';
		$str .= '</td>';
		$str .= '</tr>';
	 $i++;}?>
      <aside role="complementary">
         <button class="order-summary-toggle order-summary-toggle--show shown-if-js" aria-expanded="false" aria-controls="order-summary" data-drawer-toggle="[data-order-summary]">
            ...
            <dl class="order-summary-toggle__total-recap total-recap" data-order-summary-section="toggle-total-recap">
               <dd>
                  <span class="order-summary__emphasis total-recap__final-price skeleton-while-loading load total-price"><?=number_format($totalprice,0,',','.')?></span>
               </dd>
            </dl>
         </button>
      </aside>
         ...
         <div class="wrap">
            <div class="main">
               <header class="main__header" role="banner">
                  ...
                  <div class="wrap-promotion" style="margin-bottom:10px;">
                     <div class="promotion">
                        <div class="enter-promotion" style="width:50%;">
                           <input type="text" id="promotion" placeholder="<?=$website['promotion_code']?>">
                        </div>
                        <div class="button-promotion" style="width:30%;">
                           <a class="submit-promotion"><?=$website['btn_promotion']?></a>
                        </div>
                     </div>
                     <div class="error-promotion"></div>
                  </div>
                  <? } ?>
                  <div class="order-summary__section order-summary__section--total-lines box-promotion" style="display:none;border-top: 1px solid #d9d9d9;" data-order-summary-section="payment-lines">
                     <table class="total-line-table">
                        <tbody class="total-line-table__tbody">
                           <tr class="total-line total-line--subtotal">
                              <th class="total-line__name" scope="row"></th>
                              <td class="total-line__price">
                                 <span class="order-summary__emphasis skeleton-while-loading total" data-checkout-su-target="2200">
                           ...
                           <tr class="total-line total-line--shipping">
                              ...
                              <td class="total-line__price">
                                 <span class="skeleton-while-loading order-summary__small-text total-price-sale" data-checkout-total-shipping-target="0">
                                    0
                                 </span>
                              </td>
                           </tr>
                           <!-- <tr class="total-line total-line--taxes " data-checkout-taxes>
                              ...
                              <td class="total-line__price">
                                 <span class="order-summary__emphasis skeleton-while-loading" data-checkout-total-taxes-target="220">$2.20</span>
                              </td>
                           </tr> -->
                        </tbody>
                     </table>
                  ...
                  <nav aria-label="Breadcrumb">
                     <ol class="breadcrumb " role="list">
                        ...
                        <li class="breadcrumb__item breadcrumb__item--current" aria-current="step">
							      <a class="breadcrumb__link" href="<?=site_url("gio-hang")?>"><?=$website['my_cart']?></a>
                           <svg class="icon-svg icon-svg--color-adaptive-light icon-svg--size-10 breadcrumb__chevron-icon" aria-hidden="true" focusable="false">
                              <use xlink:href="#chevron-right" />
                           </svg>
                        </li>
               ...
               <main class="main__content" role="main">
                  <div class="step" data-step="contact_information" data-last-step="false">
                     <form id="frm-checkout" class="edit_checkout" novalidate="novalidate" data-customer-information-form="true" data-email-or-phone="true" action="<?=site_url("dat-hang/thanh-toan")?>" method="POST" accept-charset="UTF-8">
                        ...
                        <div class="step__sections">
                           <div class="section section--contact-information">
                                 ...
                                 <div class="fieldset">
                                    <div data-email-or-phone-input-wrapper="true" data-shopify-pay-email-flow="false" class="field field--email_or_phone">
                                       ...
                                       <div class="field__input-wrapper">
                                          <input value="<?=empty($booking->email) ? '' : $booking->email?>" required placeholder="Email" autocapitalize="off" spellcheck="false" data-email-or-phone-input="true" data-phone-flag-input="true" data-phone-flag-input-default-country="Vietnam" data-autofocus="true" data-backup="email_or_phone" data-address-type="shipping" data-most-popular-countries="[]" data-phone-flag-label="Country/Region code" aria-describedby="checkout-context-step-one" aria-required="true" class="field__input" size="30" type="email" name="email" id="checkout_email_or_phone" />
                                       </div>
                                    ...
                                    <div class="section__content">
                                       <div class="checkbox-wrapper">
                                          <div class="checkbox__input">
                                             <input name="checkout[buyer_accepts_marketing]" type="hidden" value="0" autocomplete="off" /><input class="input-checkbox" data-backup="buyer_accepts_marketing" type="checkbox" value="1" name="checkout[buyer_accepts_marketing]" id="checkout_buyer_accepts_marketing" />
                                          </div>
                              ...
                              <div class="fieldset">
                                 <div class="address-fields" data-address-fields>
                                    <div class="field--half field field--required" data-address-field="fullname">
                                       <label class="field__label" for="checkout_shipping_address_fullname"><?=$website['order_note3']?></label>
                                       <div class="field__input-wrapper">
                                          <input value="<?=empty($booking->fullname) ? '' : $booking->fullname?>" placeholder="<?=$website['order_note3']?>" autocomplete="shipping family-name" autocorrect="off" data-backup="fullname" class="field__input" aria-required="true" size="30" type="text" name="fullname" required id="checkout_shipping_address_fullname" />
                                       </div>
                                       <p class="field__message field__message--error"><?=$website['error_note1']?></p>
                                    </div>
                                    <div class="field--half field field--required" data-address-field="phone">
                                       <label class="field__label" for="checkout_shipping_address_phone"><?=$website['order_note4']?></label>
                                       <div class="field__input-wrapper">
                                          <input value="<?=empty($booking->phone) ? '' : $booking->phone?>" placeholder="<?=$website['order_note4']?>" autocomplete="shipping family-name" autocorrect="off" data-backup="phone" class="field__input" aria-required="true" size="30" type="text" name="phone" required id="checkout_shipping_address_phone" />
                                       </div>
                                    ...
                                    <div data-address-field="address" data-autocomplete-field-container="true" class="field field--required">
                                       ...
                                       <div class="field__input-wrapper">
                                          <input value="<?=empty($booking->address) ? '' : $booking->address?>" placeholder="<?=$website['order_note5']?>" autocomplete="shipping address-level2" autocorrect="off" data-backup="address" class="field__input" aria-required="true" size="30" type="text" name="address" required id="checkout_shipping_address_address" />
                                       </div>
                           ...
                           <div class="section section--shipping-address book-cart-shop" data-shipping-address>
                              <div class="section__header">
                                 <h2 class="section__title" id="section-delivery-title">
                                    <?=$website['order_note10']?>
                                 </h2>
                              </div>
                              <div class="payment">
                                 <div class="payment-item">
                                    <div class="radio">
                                       <label class="full-width text-center">
                                          ...
                                          <br>
                                          <input type="radio" name="payment" class="payment-method" value="Ship COD" checked> <?=$website['ship_cod']?>
                                       </label>
                                    </div>
                                 </div>
                                 <div class="payment-item">
                                    <div class="radio">
                                       <label class="full-width text-center">
                                          ...
                                          <br>
                                          <input type="radio" name="payment" class="payment-method" value="Banking"> <?=$website['banking']?>
                                       </label>
                                    </div>
                                 </div>
                              </div>
                        ...
                        <div class="step__footer" data-step-footer>
                           <a id="continue_button" class="step__footer__continue-btn btn" aria-busy="false">
                              <span class="btn__content" data-continue-button-content="true"><?=$website['payment']?></span>
                           </a>
                     ...
                     <div class="order-summary__sections">
                        <div class="order-summary__section order-summary__section--product-list">
                           <div class="order-summary__section__content">
                              ...
                              <? if(!empty($this->session->user)) { ?>
                                 <? if(!$this->util->detect_mobile()) { ?>
                                 <div class="wrap-promotion" style="padding: 10px 0;border-top: 1px solid #d0dbde;">
                                    <div class="promotion">
                                       <div class="enter-promotion" style="width:70%">
                                          <input type="text" id="promotion" placeholder="<?=$website['promotion_code']?>">
                                       </div>
                                       <div class="button-promotion" style="width:30%">
                                          <a class="submit-promotion"><?=$website['btn_promotion']?></a>
                                 ...
                                 <script>
                                    ...
                                    $('#promotion').click(function(e){
                                       $('.wrap-promotion').removeClass('error-fields');
                                    })
                                    $('.submit-promotion').click(function(e){
                                       if ($("#promotion").val() == "") {
                                          $('.error-promotion').html('Vui lòng nhập mã');
                                          $('.wrap-promotion').addClass('error-fields');
                                       } else {
                                          $.ajax({
                                             ...
                                             success: function(res) {
                                                if (res[1]){
                                                   ...
                                                   for (var i = 0; i < <?=$c?>; i++) {
                                                      var price_cost = parseFloat($('.quantity-'+i).attr('cost'))*parseInt($('.quantity-'+i).html());
                                                   ...
                                                   $('.total').html(formatDollar(total_price+total_sale_price));
                                                   $('.total-price-sale').html('-'+formatDollar(total_sale_price));
                                                   $('.box-promotion').show();
                                                   $('.total-price').html(formatDollar(total_price));
                                                } else {
                                                   if (res[0] == 0){
                                                      $('.error-promotion').html('<?=$website['error_promotion']?>');
                                                   } else if (res[0] == -1){
                                                      $('.error-promotion').html('<?=$website['error_promotion1']?> > '+formatDollar(parseFloat(res[2])));
                                                   }
                                                   $('.wrap-promotion').addClass('error-fields');
                                                   $('.box-promotion').hide();
                                                   $('.total-price').html($('.total').html());
                                                }
                                             }
                                          });
                                       }
                        ...
                        <div class="order-summary__section order-summary__section--total-lines box-promotion" style="display:none;" data-order-summary-section="payment-lines">
                           <table class="total-line-table">
                              <tbody class="total-line-table__tbody">
                                 <tr class="total-line total-line--subtotal">
                                    <th class="total-line__name" scope="row"></th>
                              ...
                              <tfoot class="total-line-table__footer">
                                 <tr class="total-line">
                                    <th class="total-line__name payment-due-label" scope="row">
                                       <span class="payment-due-label__total"><?=$website['total']?></span>
                                    </th>
                                    <td class="total-line__price payment-due" data-presentment-currency="USD">
                                       <span class="payment-due__currency remove-while-loading">VND</span>
                                       <span class="payment-due__price skeleton-while-loading--lg total-price" data-checkout-payment-due-target="2420">
                                       <?=number_format($totalprice,0,',','.')?>
                                       </span>
                                    </td>
                                 </tr>
